//! Element definitions generated from the listing on [MDN]. Because
//! topologically-nested functions are called-by-macro today, the element macros
//! generated here appear in the root module.
//!
